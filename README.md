...
**School Library** is a ruby software.
...
```sh
  git clone https://github.com/Kanyorok/School-Library.git
  cd School-Library
```
...
Feel free to check the [issues page](https://github.com/Kanyorok/School-Library/issues).
